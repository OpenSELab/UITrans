...
JSON Schema: {'properties': {'description': {'description': '组件的描述', 'title': 'Description', 'type': 'string'}, 'interfaces': {'description': '组件的接口', 'items': {'properties': {'description': {'description': '接口的描述', 'title': 'Description', 'type': 'string'}, 'params': {'additionalProperties': {'properties': {'type': {'anyOf': [{'type': 'string'}, {'items': {'type': 'string'}, 'type': 'array'}, {'additionalProperties': {'type': 'string'}, 'type': 'object'}], 'description': '参数的类型', 'title': 'Type'}, 'required': {'default': False, 'description': '是否必填参数', 'title': 'Required', 'type': 'boolean'}, 'description': {'description': '参数的描述', 'title': 'Description', 'type': 'string'}, 'default': {'anyOf': [{}, {'type': 'null'}], 'default': None, 'description': '参数的默认值', 'title': 'Default'}}, 'required': ['type', 'description'], 'title': 'ComponentParam', 'type': 'object'}, 'description': '接口的参数', 'title': 'Params', 'type': 'object'}}, 'required': ['description', 'params'], 'title': 'ComponentInterface', 'type': 'object'}, 'title': 'Interfaces', 'type': 'array'}, 'attributes': {'additionalProperties': {'properties': {'description': {'description': '属性的描述', 'title': 'Description', 'type': 'string'}, 'params': {'additionalProperties': {'properties': {'type': {'anyOf': [{'type': 'string'}, {'items': {'type': 'string'}, 'type': 'array'}, {'additionalProperties': {'type': 'string'}, 'type': 'object'}], 'description': '参数的类型', 'title': 'Type'}, 'required': {'default': False, 'description': '是否必填参数', 'title': 'Required', 'type': 'boolean'}, 'description': {'description': '参数的描述', 'title': 'Description', 'type': 'string'}, 'default': {'anyOf': [{}, {'type': 'null'}], 'default': None, 'description': '参数的默认值', 'title': 'Default'}}, 'required': ['type', 'description'], 'title': 'ComponentParam', 'type': 'object'}, 'description': '属性的参数', 'title': 'Params', 'type': 'object'}}, 'required': ['description', 'params'], 'title': 'ComponentAttribute', 'type': 'object'}, 'description': '组件的属性', 'title': 'Attributes', 'type': 'object'}, 'events': {'additionalProperties': {'properties': {'description': {'description': '事件的描述', 'title': 'Description', 'type': 'string'}, 'params': {'anyOf': [{'additionalProperties': {'properties': {'type': {'anyOf': [{'type': 'string'}, {'items': {'type': 'string'}, 'type': 'array'}, {'additionalProperties': {'type': 'string'}, 'type': 'object'}], 'description': '参数的类型', 'title': 'Type'}, 'required': {'default': False, 'description': '是否必填参数', 'title': 'Required', 'type': 'boolean'}, 'description': {'description': '参数的描述', 'title': 'Description', 'type': 'string'}, 'default': {'anyOf': [{}, {'type': 'null'}], 'default': None, 'description': '参数的默认值', 'title': 'Default'}}, 'required': ['type', 'description'], 'title': 'ComponentParam', 'type': 'object'}, 'type': 'object'}, {'type': 'null'}], 'description': '事件回调的参数', 'title': 'Params'}, 'returns': {'anyOf': [{'additionalProperties': {'properties': {'type': {'description': '返回值的类型', 'title': 'Type', 'type': 'string'}, 'description': {'description': '返回值的描述', 'title': 'Description', 'type': 'string'}}, 'required': ['type', 'description'], 'title': 'ComponentEventReturn', 'type': 'object'}, 'type': 'object'}, {'type': 'null'}], 'default': None, 'description': '事件回调的返回值', 'title': 'Returns'}}, 'required': ['description', 'params'], 'title': 'ComponentEvent', 'type': 'object'}, 'description': '组件的事件', 'title': 'Events', 'type': 'object'}, 'examples': {'anyOf': [{'items': {'type': 'string'}, 'type': 'array'}, {'type': 'null'}], 'default': None, 'description': '组件的使用示例', 'title': 'Examples'}, 'is_common_attrs': {'default': True, 'description': '是否支持通用属性', 'title': 'Is Common Attrs', 'type': 'boolean'}}, 'required': ['description', 'interfaces', 'attributes', 'events'], 'title': 'ComponentDeclaration', 'type': 'object'}
