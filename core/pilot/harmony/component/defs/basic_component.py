BASIC_COMPONENT = {
    ...
    "Toggle": {
        ...
        "interfaces": [
            {
                "description": "Toggle组件接口",
                "params": {
                    "type": {
                        "type": "ToggleType",
                        "required": True,
                        "description": "开关的样式。默认值：ToggleType.Switch。",
                        "default": "ToggleType.Switch"
                    },
                    "isOn": {
                        "type": "boolean",
                        "required": False,
                        "description": "开关是否打开，True：打开，False：关闭。从API version 10开始，该参数支持双向绑定变量。"
                    }
                }
            }
        ],
            ...
            "selectedColor": {
                ...
                "params": {
                    "value": {
                        "type": "ResourceColor",
                        "required": True,
                        "description": "组件打开状态的背景颜色。默认值：'#ffffffff'",
                        "default": "#ffffffff"
                    }
                }
            },
            "switchPointColor": {
                ...
                "params": {
                    "color": {
                        "type": "ResourceColor",
                        "required": True,
                        "description": "Switch类型的圆形滑块颜色。默认值：'#ffffffff'",
                        "default": "#ffffffff"
                    }
                }
            },
            "switchStyle": {
                "description": "设置Switch类型的样式。",
                "params": {}
            },
            "contentModifier": {
